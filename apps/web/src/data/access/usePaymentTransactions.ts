...
// ─── Claim type stubs ─────────────────────────────────────────────────────────
// The original usePaymentTransactions imports Claim from FundsClaimsContent
// and ClaimStatus from StatusChip — both Tailwind/shadcn components that are
// not yet ported. Until they are, we stub the types here so the hook compiles.
// TODO: port FundsClaimsContent and StatusChip from vw-funds-2
...
// Stub for CLAIMS_MOCK_DATA — replaced with an empty array until the component is ported.
// TODO: wire real CLAIMS_MOCK_DATA once FundsClaimsContent is ported

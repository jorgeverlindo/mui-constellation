...
import { zoneConfigs, visibleSlotBounds, isSingleProductTextLayout, isKeyMessageTextLayout, isPharmaZoneConfig } from "../lib/template-zone-configs";
import type { TemplateZoneConfig, PharmaZoneConfig, SingleProductTextLayout, MultiProductTextLayout, KeyMessageTextLayout, PharmaTextLayout, TextElement } from "../lib/template-zone-configs";
...
const ISI_COLOR   = "#2563eb";
const LOGO_PH_COLOR = "#7c3aed";
  ...
  return (
    <Box sx={{ display: "flex", flexWrap: "wrap", gap: 0.5, pt: 1 }}>
      {items.map(({ color, label }) => (
        <Box key={label} component="span" sx={{ display: "flex", alignItems: "center", gap: 0.5, fontSize: "0.625rem", color: "text.secondary" }}>
          <span style={{ width: 10, height: 10, borderRadius: 2, background: color, display: "inline-block", flexShrink: 0 }} />
          {label}
        </Box>
      ))}
      <Box component="span" sx={{ display: "flex", alignItems: "center", gap: 0.5, fontSize: "0.625rem", color: "text.secondary" }}>

 ...
 * Standalone list — mirrors PROJECT_OWNERS from the source app.
 */
export const COMMENT_USERS: CommentUser[] = [
  { id: "user-jorge",   name: "Jorge Verlindo",  email: "jorge.verlindo@helloconstellation.com",   initials: "JV", color: "#473BAB", avatar: null },
  { id: "user-mallory", name: "Mallory Manning", email: "mallory.manning@helloconstellation.com",  initials: "MM", color: "#E17613", avatar: null },
  { id: "user-alex",    name: "Alex Chen",       email: "alex.chen@helloconstellation.com",         initials: "AC", color: "#2196F3", avatar: null },
];

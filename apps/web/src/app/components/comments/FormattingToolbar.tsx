...
// No Tailwind / shadcn — all styling via inline style or sx prop.
  ...
  return (
    <Box
      ...
      sx={{
        ...
        color: 'text.secondary', bgcolor: 'transparent', border: 'none', cursor: 'pointer',
        userSelect: 'none',
...
export function FormattingToolbar({ onFormat, onMentionTrigger, onAttach, className = "" }: FormattingToolbarProps) {
  return (
    ...
    >
      ...
      {/* Divider */}
      <Box sx={{ width: '1px', height: 16, bgcolor: '#e8e7ef', mx: '4px' }} />
      ...
      {/* Ordered list */}
      <ToolbarButton title="Ordered list" command="insertOrderedList" onFormat={onFormat}>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Unordered list */}
      <ToolbarButton title="Unordered list" command="insertUnorderedList" onFormat={onFormat}>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">

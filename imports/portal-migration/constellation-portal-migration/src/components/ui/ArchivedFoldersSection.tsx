    ...
    <>
      <Box sx={{ px: 2, pt: 2, pb: 1, flexShrink: 0 }}>
        ...
        <Typography sx={{
          ...
          color: TEXT_DIM, fontFamily: 'Roboto, sans-serif', mb: 1.25,
        }}>
          ...
          {archivedFolders.map(folder => (
            <Box
              ...
              sx={{
                ...
                border: `1px solid ${BORDER}`, bgcolor: '#fafafa',
                '&:hover': { bgcolor: '#f5f5f7', borderColor: 'rgba(0,0,0,0.14)' },
            ...
            >
              ...
              {folder.count !== undefined && (
                <Typography sx={{ fontSize: 12, color: TEXT_DIM, fontFamily: 'Roboto, sans-serif', flexShrink: 0 }}>
                  ({folder.count})
                </Typography>
              )}
              <Tooltip title="Restore from archive" placement="top">
                <IconButton
                  size="small"
                  onClick={() => handleUnarchive(folder.id, folder.name)}
                  sx={{
                    p: '3px', color: TEXT_DIM, flexShrink: 0,
                    '&:hover': { color: BRAND, bgcolor: `${BRAND}10` },
                  }}
                >
